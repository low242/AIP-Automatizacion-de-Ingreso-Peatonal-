...
<body>
    @if ($personas->count() > 0)
        @foreach ($personas->chunk(6) as $pagina)
            <div class="page">
                <table class="sheet">
                    @foreach ($pagina->chunk(2) as $fila)
                        <tr>
                                    ...
                                    <div class="carnet">
                                        <table class="top-table">
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($persona->photoDataUri)
                                                        <img src="{{ $persona->photoDataUri }}" alt="Foto" class="photo">
                                                    @else
                                        ...
                                        <img src="{{ $persona->qrDataUri }}" alt="Codigo QR" class="qr">
